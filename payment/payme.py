...
client = PaymeSubscribeCards(
    ...
    paycom_id="656d9a2694dc4293bdd4712d"
)
...
class PaymeSubscribeReceipts:
    ...
    def _receipts_create(self, id: int, amount: float, order_id: int, title: str, price: int, code: str,
                         package_code: str) -> dict:
...
client_receipt = PaymeSubscribeReceipts(
    base_url="https://checkout.paycom.uz/api/",
    paycom_id="656d9a2694dc4293bdd4712d",
    paycom_key="txig0epiUPBMaY3c&#senn29SU4wh3ejQaO#"
)